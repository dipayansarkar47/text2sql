...
export default function TextForm() {
    ...
    const handleRemoveField = (index) => {
        if (fields.length === 1) return; // Ensure there's at least one field
    ...
    const handleFieldChange = (index, value) => {
        const newFields = [...fields];
        newFields[index] = value.replace(/\s/g, ''); // Remove spaces
        setFields(newFields);
    };
    ...
    const handleGenerateSQL = () => {
        // Here you can write your logic to generate SQL
        // For demonstration, I'm just logging the inputs
        console.log(`Table Name: ${tableName}`);
        console.log(`Fields: ${chips.join(', ')}`);
                ...
                <div className="flex flex-col justify-center items-center w-full gap-4">
                    ...
                    <div className='w-full'>
                        ...
                        <input
                            ...
                            className="w-full border-2 border-gray-500 bg-gray-800 p-2 text-white rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm"
            ...
            <div className="mb-8">
                ...
                <div>
                    <textarea
                        ...
                        className="mt-1 block w-full border-2 border-gray-500 bg-gray-800 p-2 text-white rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm"
                        rows="7"
                        value={query}
